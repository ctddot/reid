...
def get_logger(name: str = "reidcli") -> logging.Logger:
    ...
    if not logger.handlers:
        ...
        # Set REIDCLI_LOG_LEVEL=INFO (or DEBUG) to see verbose logs.
        import os

        level = os.environ.get("REIDCLI_LOG_LEVEL", "WARNING").upper()
