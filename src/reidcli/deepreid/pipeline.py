...
See deepreid-spec.md (repo root, one level above ReidCLI/) for the full
...
from reidcli.tools.file_tools import FindFilesTool, GrepFilesTool, ListDirTool, ReadFileTool
from reidcli.tools.registry import ToolRegistry
from reidcli.tools.web_tools import WebSearchTool
...
def save_deepreid_result(config: Config, result: DeepReidResult) -> Path:
    storage_root = config.storage_root or (Path.home() / ".reidcli")
